                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    @foreach($access_permissions as $perm)
                                         <input type="checkbox" value="{{$perm->id}}" name="access_permissions[]" {!! in_array($perm->id, $user->access_permissions) ? 'checked' : '' !!} id="perm-{{$perm->id}}" /> <label for="perm-{{$perm->id}}">{!! $perm->title !!}</label><br/>
                                    @endforeach
                                    <p><a href="#" id="checkAll">Check all</a></p>
...
<script type="text/javascript" defer="defer">
    ...
    $("#checkAll").click(function (event) {
        ...
        $('input[type="checkbox"][name*="access_permissions"]').prop('checked', $('input[type="checkbox"][name*="access_permissions"]:not(:checked)').length>0 );
    });
</script>
@endsection
