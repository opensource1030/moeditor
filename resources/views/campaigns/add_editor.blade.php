            ...
            <div class="col-md-5">   
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 text-right">
                         <a href="/campaigns/str/{{$campaign->id}}">
                            ...
                            @foreach($campaign->template as $ct)
                                ...
                                @endif
                                    ...
                                    <div class="col-md-1">
                                        ...
                                        <span data-edid="{{$ct->id}}" class="glyphicon glyphicon-plus editor"></span>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                         ...
                         <div  id="optimization_divs" >
                            ...
                            <div class="col-md-12" style="margin: 10px 0;">
                                    <div class="btn-group optimization_type" data-toggle="buttons">
                                        <label class="btn btn-sm btn-blue @if($campaign->ao_type == 'click') active @endif">
                                            <input type="radio" name="ao_type" id="click_option" value="click" @if($campaign->ao_type == 'click') checked @endif>
                                        Click %</label>
                                        <label class="btn btn-sm btn-blue @if($campaign->ao_type == 'optin') active @endif opt_int ">
                                            <input type="radio" name="ao_type" id="optin_option" value="optin" @if($campaign->ao_type == 'optin') checked @endif>
                                        Optin %</label>
                                        <label class="btn btn-sm btn-blue @if($campaign->ao_type == 'conversion') active @endif opt_int ">
                                            <input type="radio" name="ao_type" id="conversion_option" value="conversion" @if($campaign->ao_type == 'conversion') checked @endif>
                                        Conversion %</label>
                                    </div>
                            ...
                            @if(isset($ao_clicks))
                                <p>Campaign has <b>{!! $ao_clicks !!}</b> optimization clicks</p>
                            @endif
                            <style>
