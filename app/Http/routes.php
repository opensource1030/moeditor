...
Route::group(['prefix' => 'v2', 'middleware' => 'auth'], function () {
    Route::post('campaigns/create', 'CampaignsController@createCampaignV2');
    Route::post('campaigns/seo-image', 'CampaignsController@seoImageV2');
    Route::post('campaigns/saveVariation', 'CampaignsController@saveVariationV2');
    Route::post('campaigns/saveSeo', 'CampaignsController@saveSeoV2');
    Route::post('upload-image', 'CampaignsController@uploadImageV2');
    Route::post('campaigns/deleteVariation', 'CampaignsController@deleteVariationV2');
    Route::post('previewTemplate', 'CampaignsController@previewTemplateV2');
    Route::get('campaigns/{campaign_id}/variations/{variation_id}', 'CampaignsController@getVariationV2');
    Route::get('preview', 'CampaignsController@previewV2');
    Route::get('campaigns/{campaign_id}/edit', 'CampaignsController@editCampaignV2');
    Route::get('campaigns/{campaign_id}/variations', 'CampaignsController@getAllVariationsV2');
    Route::get('campaigns/{campaign_id}/canUseOptimisation', 'CampaignsController@canUseOptimisationV2');
    Route::get('campaigns/{campaign_id}/delete-seo-image', 'CampaignsController@removeSeoImageV2');
});
...
Route::any('/fileman', ['middleware' => 'auth', function(){
        include 'fileman-secure/index.html';
        return;
    }]);
...
$router->group(
    ...
    $router->get(
        'editor/{id}/{editor}', [
            'as' => 'editor_campaigns',
            'permission' => 'manage_campaign',
            'uses' => 'CampaignsController@editor'
        ]
    )->where(
        [
            'id' => '[0-9]+',
...
$router->group(
    ...
    $router->group([ 'prefix' => 'users'], function () use ( $router ) {
        ...
        // user logs
        $router->get('user_logs/{id}', [
                'uses' => 'UserController@user_logs',
                'as' => 'user_logs',
            ]
        );
        //delete user
...
Route::any('profile', array('as' => 'profile', 'uses' => function () {
        ...
        if ($user) {
            if (Request::isMethod('post')) {
                ...
                $data['user'] = $user;
                $data['access_permissions'] = \DB::table('access_permissions')->whereIn('id', unserialize(Auth::user()->access_permissions))->lists('slug');
